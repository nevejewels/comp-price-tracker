...
<head>
    <style>
        ...
        .light-red-sample {{ background-color: #ffcccc; }}
        .light-green-sample {{ background-color: #ccffcc; }}
        .notes {{
...
<body>
    <div class="container">
        ...
        <div class="legend">
            <h3 style="margin-top: 0; color: #007acc;">🎨 Color Legend</h3>
            
            <h4 style="margin-bottom: 10px;">Report 1 - Competitor Comparison:</h4>
            ...
            <h4 style="margin: 20px 0 10px 0;">Report 2 - Price Trends:</h4>
            <div class="legend-item">
                <span class="color-sample light-red-sample"></span>
                <span><strong>Light Red:</strong> Price increased (↑) compared to previous day</span>
            </div>
            <div class="legend-item">
                <span class="color-sample light-green-sample"></span>
                <span><strong>Light Green:</strong> Price decreased (↓) compared to previous day</span>
            </div>
            <div class="legend-item">
                <span style="margin-right: 40px;"></span>
                <span><strong>No color:</strong> No price change (→)</span>
            </div>
        </div>
